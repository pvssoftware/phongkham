...
from .views_api import  create_record_ticket, get_doctor, CustomAuthToken, get_examination_patients, upload_medical_ultrasonography_file, delete_token_logout, get_update_app_win
...
urlpatterns = format_suffix_patterns([
    ...
    url(r'^check-update-app-win/', get_update_app_win),
])