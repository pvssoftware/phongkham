...
from .views_api import  create_record_ticket, get_doctor, CustomAuthToken, get_examination_patients, upload_medical_ultrasonography_file, delete_token_logout, check_version_app
